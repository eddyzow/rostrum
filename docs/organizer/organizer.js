        ...
        <div class="space-y-8">
            <div id="event-settings" class="bg-gray-800/50 rounded-2xl p-8">
              ...
              <div class="mt-8 pt-8 border-t border-gray-700">
                ...
                <p class="text-lg font-semibold text-gray-200 mb-4">Tell attendees to go to <a href="https://eddyzow.net/rostrum" target="_blank" class="text-indigo-400 hover:underline">eddyzow.net/rostrum</a> and enter this code:</p>
...
<div class="mt-4 flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0">
  ...
  const renderVotingResultsPage = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/get-voting-results",
        {
          method: "POST",
  ...
  const loadEventDetails = async (eventCode, token) => {
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/get-event-details",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const checkLoginStatus = async () => {
    ...
    if (tokenFromUrl) {
      try {
        const response = await fetch(
          "https://eddyzow.herokuapp.com/api/verify-organizer-magic-token",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
  ...
  function setupLoginListeners() {
    ...
    if (getMagicLinkButton) {
      getMagicLinkButton.addEventListener("click", async () => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/send-organizer-magic-link",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
  ...
  function setupDashboardListeners() {
    ...
    if (newEventForm) {
      newEventForm.addEventListener("submit", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/create-event",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
  ...
  function setupDetailsEventListeners() {
    ...
    eventDetailsForm.addEventListener("submit", async (e) => {
      ...
      try {
        const response = await fetch(
          "https://eddyzow.herokuapp.com/api/update-event-details",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
  ...
  function setupOrganizersEventListeners() {
    ...
    if (addOrganizerEmailButton) {
      addOrganizerEmailButton.addEventListener("click", async () => {
        ...
        try {
          const token = localStorage.getItem("podium-pro-organizer-token");
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/add-organizer-to-event",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
    ...
    document.querySelectorAll(".permission-selector").forEach((select) => {
      select.addEventListener("change", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/update-organizer-permission",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
  ...
  function setupProjectsEventListeners() {
      ...
      projectListContainer.addEventListener("submit", async (e) => {
        ...
        if (e.target.classList.contains("project-edit-form")) {
          ...
          try {
            const token = localStorage.getItem("podium-pro-organizer-token");
            const response = await fetch(
              "https://eddyzow.herokuapp.com/api/update-project-organizer",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
    ...
    document.querySelectorAll(".save-status-button").forEach((button) => {
      button.addEventListener("click", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/update-project-status-organizer",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
    ...
    document.querySelectorAll(".ban-voter-btn").forEach((button) => {
      button.addEventListener("click", async (e) => {
        ...
        if (
          ...
          try {
            const response = await fetch(
              "https://eddyzow.herokuapp.com/api/ban-voter",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
    ...
    document.querySelectorAll(".unban-voter-btn").forEach((button) => {
      button.addEventListener("click", async (e) => {
        ...
        if (confirm("Are you sure you want to unban this voter?")) {
          ...
          try {
            const response = await fetch(
              "https://eddyzow.herokuapp.com/api/unban-voter",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
    ...
    document.querySelectorAll(".erase-votes-btn").forEach((button) => {
      button.addEventListener("click", async (e) => {
        ...
        if (
          ...
          try {
            const response = await fetch(
              "https://eddyzow.herokuapp.com/api/erase-voter-votes",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
  ...
  function setupAwardsEventListeners() {
    ...
    if (form) {
      form.addEventListener("submit", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/update-awards-settings",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
    ...
    function handleRemoveButton(e) {
      ...
      confirmationDiv
        ...
        ?.addEventListener("click", async () => {
          ...
          try {
            const response = await fetch(
              "https://eddyzow.herokuapp.com/api/remove-attendee-organizer",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
        ...
        ?.addEventListener("click", async () => {
          ...
          try {
            const banResponse = await fetch(
              "https://eddyzow.herokuapp.com/api/add-ban",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
        ...
        if (e.target.classList.contains("unban-btn")) {
          ...
          promptContainer
            ...
            ?.addEventListener("click", async () => {
              ...
              try {
                const response = await fetch(
                  "https://eddyzow.herokuapp.com/api/unban",
                  {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
      ...
      if (!deleteButton.disabled) {
        ...
        document
          ...
          ?.addEventListener("click", async () => {
            ...
            try {
              const response = await fetch(
                "https://eddyzow.herokuapp.com/api/delete-event",
                {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
