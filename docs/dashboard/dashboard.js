...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const verifyTokenAndRender = async () => {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/verify-magic-token",
        {
          method: "POST",
  ...
  async function pollProjectStatus() {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/get-project-status",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
<div>
  ...
  async function handleSaveProject() {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/save-project",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  async function handleLeaveProject(button) {
    ...
    promptContainer
      ...
      .addEventListener("click", async () => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/leave-project",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ token }),
  ...
  function setupProjectForm() {
    ...
    if (dismissNoteButton) {
      dismissNoteButton.addEventListener("click", async () => {
        const token = localStorage.getItem("podium-pro-token");
        const response = await fetch(
          "https://eddyzow.herokuapp.com/api/clear-ship-note",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ token }),
  ...
  function setupProjectForms() {
    ...
    if (joinProjectForm) {
      ...
      joinProjectForm.addEventListener("submit", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/join-project-with-code",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
    ...
    if (createProjectForm) {
      ...
      createProjectForm.addEventListener("submit", async (e) => {
        ...
        try {
          const response = await fetch(
            "https://eddyzow.herokuapp.com/api/create-project",
            {
              method: "POST",
              headers: { "Content-Type": "application/json" },
  ...
  async function updateShipStatus(newStatus, shouldPoll = true) {
    ...
    const token = localStorage.getItem("podium-pro-token");
    const response = await fetch(
      "https://eddyzow.herokuapp.com/api/update-ship-status",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  function setupTeamManagement() {
    ...
    if (addForm) {
      addForm.addEventListener("submit", async (e) => {
        ...
        const token = localStorage.getItem("podium-pro-token");
        const response = await fetch(
          "https://eddyzow.herokuapp.com/api/add-teammate",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
        ...
        if (e.target.classList.contains("remove-teammate-btn")) {
          ...
          promptContainer
            ...
            .addEventListener("click", async () => {
              ...
              try {
                const response = await fetch(
                  "https://eddyzow.herokuapp.com/api/remove-teammate",
                  {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
    ...
    if (teamNameForm) {
      teamNameForm.addEventListener("submit", async (e) => {
        ...
        saveButton.textContent = "Saving...";
        const response = await fetch(
          "https://eddyzow.herokuapp.com/api/save-team-name",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
  ...
  async function fetchAndRenderMatchup() {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/get-next-matchup",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ token }),
  ...
  async function handleVote(sliderValue, matchup) {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/submit-vote",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  async function handleTie(matchup) {
    ...
    try {
      const response = await fetch(
        "https://eddyzow.herokuapp.com/api/submit-tie",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
